...
World :: struct {
	all_tile_maps : []Tile_Map,

	upper_left_x, upper_left_y, tile_side_in_meters, tile_side_in_pixels, meters_to_pixels : f32,
	count_x, count_y, tile_map_count_x, tile_map_count_y : i32
}
...
Canonical_Pos :: struct{
	//tile map is what map we are in tilex what tile we are in thea actual map
	tile_map_x, tile_map_y, tile_x, tile_y : i32,
	//player pos in pixels
