...
Game_Memory :: struct {
	...
	is_initialized:         bool,
	debug_read_entire_file: proc(filename: cstring16) -> Debug_Read_File_Result,
}

Game_State :: struct {
	world_arena:               mem.Arena,
	world:                     ^World,
	player_p, camera_p:                  Tile_Map_Position,
	backdrop:                  ^img.Image,
	pixel_width, pixel_height: u32,
	pixel_pointer:             ^u32,
...
Hero_Bitmaps :: struct {
	align_x, align_y : i32,
	hero_head, hero_cape, hero_torso: ^img.Image,
}
