...
game_update_and_render :: proc(
	...
	if p_game_memory.is_initialized == false {
		...
		game_state.pixel_pointer = debug_load_bmp("data/test/test_background.bmp", p_game_memory.debug_read_entire_file)
	...
	for rel_row: i32 = -100; rel_row < 100; rel_row += 1 {
		for rel_column: i32 = -200; rel_column < 200; rel_column += 1 {
